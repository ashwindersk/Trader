...
class Agent(object):
    def __init__(self,alpha, beta, input_dims, tau, gamma = 0.99, n_actions = 2,
                  ...
                  MAX_ACTION = 1000, actor_name ='Actor-DDPG-optimised-reward-dissertation', target_actor_name ='TargetActor-DDPG-optimised-reward-dissertation',
                  critic_name ='Critic-DDPG-optimised-reward-dissertation', target_critic_name = 'TargetCritic-DDPG-optimised-reward-dissertation' ):
        self.gamma = gamma
        self.tau = tau
